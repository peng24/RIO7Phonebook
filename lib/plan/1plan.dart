...
class OnePlan extends StatefulWidget {
  @override
  _OnePlanState createState() => _OnePlanState();
}

class _OnePlanState extends State<OnePlan> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/plan/1');
