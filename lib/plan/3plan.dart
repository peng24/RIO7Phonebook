...
class ThreePlan extends StatefulWidget {
  @override
  _ThreePlanState createState() => _ThreePlanState();
}

class _ThreePlanState extends State<ThreePlan> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/plan/3');
