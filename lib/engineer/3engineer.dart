...
class ThreeEngineer extends StatefulWidget {
  @override
  _ThreeEngineerState createState() => _ThreeEngineerState();
}

class _ThreeEngineerState extends State<ThreeEngineer> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/engineer/3');
