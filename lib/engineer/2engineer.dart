...
class TwoEngineer extends StatefulWidget {
  @override
  _TwoEngineerState createState() => _TwoEngineerState();
}

class _TwoEngineerState extends State<TwoEngineer> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/engineer/2');
