...
class OneEngineer extends StatefulWidget {
  @override
  _OneEngineerState createState() => _OneEngineerState();
}

class _OneEngineerState extends State<OneEngineer> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/engineer/1');
