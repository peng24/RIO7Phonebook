...
class SubBoss extends StatefulWidget {
  @override
  _SubBossState createState() => _SubBossState();
}

class _SubBossState extends State<SubBoss> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/v1/boss/2');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('รองผู้อำนวยการสำนักงานชลประทานที่ 7'),
      ),
      body: Center(
        child: isLoading
