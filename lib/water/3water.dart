...
class ThreeWater extends StatefulWidget {
  @override
  _ThreeWaterState createState() => _ThreeWaterState();
}

class _ThreeWaterState extends State<ThreeWater> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/water/3');
