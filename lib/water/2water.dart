...
class TwoWater extends StatefulWidget {
  @override
  _TwoWaterState createState() => _TwoWaterState();
}

class _TwoWaterState extends State<TwoWater> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/water/2');
