...
class OneWater extends StatefulWidget {
  @override
  _OneWaterState createState() => _OneWaterState();
}

class _OneWaterState extends State<OneWater> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/water/1');
