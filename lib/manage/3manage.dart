...
class ThreeManage extends StatefulWidget {
  @override
  _ThreeManageState createState() => _ThreeManageState();
}

class _ThreeManageState extends State<ThreeManage> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/manage/3');
