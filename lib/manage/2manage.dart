...
class TwoManage extends StatefulWidget {
  @override
  _TwoManageState createState() => _TwoManageState();
}

class _TwoManageState extends State<TwoManage> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/manage/2');
