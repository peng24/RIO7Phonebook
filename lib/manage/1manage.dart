...
class OneManage extends StatefulWidget {
  @override
  _OneManageState createState() => _OneManageState();
}

class _OneManageState extends State<OneManage> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/manage/1');
