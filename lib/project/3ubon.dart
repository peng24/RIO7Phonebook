...
class ThreeUbon extends StatefulWidget {
  @override
  _ThreeUbonState createState() => _ThreeUbonState();
}

class _ThreeUbonState extends State<ThreeUbon> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/ubon/3');
