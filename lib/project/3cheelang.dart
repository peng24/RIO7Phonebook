...
class ThreeCheelang extends StatefulWidget {
  @override
  _ThreeCheelangState createState() => _ThreeCheelangState();
}

class _ThreeCheelangState extends State<ThreeCheelang> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/cheelang/3');
