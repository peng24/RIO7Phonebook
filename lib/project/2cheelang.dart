...
class TwoCheelang extends StatefulWidget {
  @override
  _TwoCheelangState createState() => _TwoCheelangState();
}

class _TwoCheelangState extends State<TwoCheelang> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/cheelang/2');
