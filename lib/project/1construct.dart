...
class OneConstruct extends StatefulWidget {
  @override
  _OneConstructState createState() => _OneConstructState();
}

class _OneConstructState extends State<OneConstruct> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/construct/1');
