...
class OneMuk extends StatefulWidget {
  @override
  _OneMukState createState() => _OneMukState();
}

class _OneMukState extends State<OneMuk> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/muk/1');
