...
class ThreeConstruct extends StatefulWidget {
  @override
  _ThreeConstructState createState() => _ThreeConstructState();
}

class _ThreeConstructState extends State<ThreeConstruct> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/construct/3');
