...
class OneNamkam extends StatefulWidget {
  @override
  _OneNamkamState createState() => _OneNamkamState();
}

class _OneNamkamState extends State<OneNamkam> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/namkam/1');
