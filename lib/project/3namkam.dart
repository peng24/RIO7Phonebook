...
class ThreeNamkam extends StatefulWidget {
  @override
  _ThreeNamkamState createState() => _ThreeNamkamState();
}

class _ThreeNamkamState extends State<ThreeNamkam> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/namkam/3');
