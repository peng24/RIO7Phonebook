...
class ThreeDomnoi extends StatefulWidget {
  @override
  _ThreeDomnoiState createState() => _ThreeDomnoiState();
}

class _ThreeDomnoiState extends State<ThreeDomnoi> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/domnoi/3');
