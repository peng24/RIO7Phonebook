...
class ThreeMuk extends StatefulWidget {
  @override
  _ThreeMukState createState() => _ThreeMukState();
}

class _ThreeMukState extends State<ThreeMuk> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/muk/3');
