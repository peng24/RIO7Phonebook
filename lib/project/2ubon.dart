...
class TwoUbon extends StatefulWidget {
  @override
  _TwoUbonState createState() => _TwoUbonState();
}

class _TwoUbonState extends State<TwoUbon> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/ubon/2');
