...
class TwoNamkam extends StatefulWidget {
  @override
  _TwoNamkamState createState() => _TwoNamkamState();
}

class _TwoNamkamState extends State<TwoNamkam> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/namkam/2');
