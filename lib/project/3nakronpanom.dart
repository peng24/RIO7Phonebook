...
class ThreeNakron extends StatefulWidget {
  @override
  _ThreeNakronState createState() => _ThreeNakronState();
}

class _ThreeNakronState extends State<ThreeNakron> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/nakronpanom/3');
