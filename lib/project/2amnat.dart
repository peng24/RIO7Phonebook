...
class TwoAmnat extends StatefulWidget {
  @override
  _TwoAmnatState createState() => _TwoAmnatState();
}

class _TwoAmnatState extends State<TwoAmnat> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/amnat/2');
