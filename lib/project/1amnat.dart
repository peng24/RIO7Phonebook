...
class OneAmnat extends StatefulWidget {
  @override
  _OneAmnatState createState() => _OneAmnatState();
}

class _OneAmnatState extends State<OneAmnat> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/amnat/1');
