...
class OneCheelang extends StatefulWidget {
  @override
  _OneCheelangState createState() => _OneCheelangState();
}

class _OneCheelangState extends State<OneCheelang> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/cheelang/1');
