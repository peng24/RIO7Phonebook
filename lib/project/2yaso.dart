...
class TwoYaso extends StatefulWidget {
  @override
  _TwoYasoState createState() => _TwoYasoState();
}

class _TwoYasoState extends State<TwoYaso> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/yaso/2');
