...
class TwoNakron extends StatefulWidget {
  @override
  _TwoNakronState createState() => _TwoNakronState();
}

class _TwoNakronState extends State<TwoNakron> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/nakronpanom/2');
