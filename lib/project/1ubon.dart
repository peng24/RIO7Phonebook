...
class OneUbon extends StatefulWidget {
  @override
  _OneUbonState createState() => _OneUbonState();
}

class _OneUbonState extends State<OneUbon> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/ubon/1');
