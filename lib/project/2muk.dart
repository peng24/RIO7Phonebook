...
class TwoMuk extends StatefulWidget {
  @override
  _TwoMukState createState() => _TwoMukState();
}

class _TwoMukState extends State<TwoMuk> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/muk/2');
