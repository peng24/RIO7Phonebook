...
class TwoDomnoi extends StatefulWidget {
  @override
  _TwoDomnoiState createState() => _TwoDomnoiState();
}

class _TwoDomnoiState extends State<TwoDomnoi> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/domnoi/2');
