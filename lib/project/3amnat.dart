...
class ThreeAmnat extends StatefulWidget {
  @override
  _ThreeAmnatState createState() => _ThreeAmnatState();
}

class _ThreeAmnatState extends State<ThreeAmnat> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/amnat/3');
