...
class OneDomnoi extends StatefulWidget {
  @override
  _OneDomnoiState createState() => _OneDomnoiState();
}

class _OneDomnoiState extends State<OneDomnoi> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/domnoi/1');
