...
class OneYaso extends StatefulWidget {
  @override
  _OneYasoState createState() => _OneYasoState();
}

class _OneYasoState extends State<OneYaso> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/yaso/1');
