...
class ThreeYaso extends StatefulWidget {
  @override
  _ThreeYasoState createState() => _ThreeYasoState();
}

class _ThreeYasoState extends State<ThreeYaso> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/yaso/3');
