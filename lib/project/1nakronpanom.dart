...
class OneNakron extends StatefulWidget {
  @override
  _OneNakronState createState() => _OneNakronState();
}

class _OneNakronState extends State<OneNakron> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/nakronpanom/1');
