...
class OneMachine extends StatefulWidget {
  @override
  _OneMachineState createState() => _OneMachineState();
}

class _OneMachineState extends State<OneMachine> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/machine/1');
