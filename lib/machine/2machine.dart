...
class TwoMachine extends StatefulWidget {
  @override
  _TwoMachineState createState() => _TwoMachineState();
}

class _TwoMachineState extends State<TwoMachine> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/machine/2');
