...
class ThreeMachine extends StatefulWidget {
  @override
  _ThreeMachineState createState() => _ThreeMachineState();
}

class _ThreeMachineState extends State<ThreeMachine> {
  var users;
  bool isLoading = true;

  String endPoint = 'https://www.rid7.com/phonebook/api/public';
  Future<Null> getUsers() async {
    final response = await http.get('$endPoint/machine/3');
